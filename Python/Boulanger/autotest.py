...
search_result_list = browser.find_elements_by_css_selector('.product-item')
for product_element in search_result_list:
    product_text = product_element.find_element_by_css_selector('.product-item__label').text
